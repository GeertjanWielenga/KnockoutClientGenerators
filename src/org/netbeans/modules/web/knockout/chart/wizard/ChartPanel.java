 ...
 *
 */
public class ChartPanel implements WizardDescriptor.FinishablePanel<WizardDescriptor>
{
    public static enum JsUi {
        NO_UI(NbBundle.getMessage(ChartPanel.class, "TXT_NoUi")),                // NOI18N
        TABLESORTER(NbBundle.getMessage(ChartPanel.class, "TXT_TablesorterUi")); // NOI18N
    ...
    public ChartPanel(WizardDescriptor descriptor) {
        myWizard = descriptor;
    }
    ...
    public Component getComponent() {
        if ( myComponent == null ){
            myComponent = new ChartPanelVisual(this);
        }
        return myComponent;
    }
    ...
    private ChartPanelVisual myComponent;
